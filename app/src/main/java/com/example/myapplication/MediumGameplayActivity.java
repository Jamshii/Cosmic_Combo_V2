...
public class MediumGameplayActivity extends AppCompatActivity {

    TextView tv_timer, tv_score, tv_round;

    ImageView iv_11, iv_12, iv_13, iv_21, iv_22, iv_23, iv_31, iv_32, iv_33, iv_41, iv_42, iv_43, btnPause, btnHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardPressedSoundId = soundPool.load(MediumGameplayActivity.this, R.raw.card_pressed, 1);
        cardMatchSoundId = soundPool.load(MediumGameplayActivity.this, R.raw.match_found, 1);
        cardNotMatchSoundId = soundPool.load(MediumGameplayActivity.this, R.raw.match_notfound, 1);

        playerName = getIntent().getStringExtra("playerName");

        gameMusic = MediaPlayer.create(MediumGameplayActivity.this,R.raw.gameplay_audio);
        ...
        pauseDialog = new Dialog(MediumGameplayActivity.this);
        ...
        OnBackPressedCallback callback = new OnBackPressedCallback(true) {
            ...
            public void handleOnBackPressed() {
                Intent intent = new Intent(MediumGameplayActivity.this, MainActivity.class);
                startActivity(intent);
                countDownTimer.cancel();
                MediumGameplayActivity.this.finish();
            }
        };
    ...
    public void gameOver(){
        Intent intent = new Intent(MediumGameplayActivity.this,GameOverScreen.class);
